...
public:
    ...
    uint8_t HW_Dimming1[4] = {0x00, 0xff, 0x0c, static_cast<uint8_t>(~(0x0c))};                        /*光源档位 加1 命令					不修改*/
    uint8_t HW_Dimming2[4] = {0x00, 0xff, 0x18, static_cast<uint8_t>(~(0x18))};                        /*光源档位 加2 命令					不修改*/
    uint8_t HW_Dimming3[4] = {0x00, 0xff, 0x5e, static_cast<uint8_t>(~(0x5e))};                        /*光源档位 加3 命令					不修改*/
