...
//
//uint8_t command06[ 8 ] = { 0x55,0x04,0x01 ,0x00 ,0x00 ,0x00 ,0x00 ,0xbb };	/*carLight???????????*/
//uint8_t command07[ 8 ] = { 0x55,0x04,0x02 ,0x00 ,0x00 ,0x00 ,0x00 ,0xbb };	/*carLight???????????*/
//uint8_t command08[ 8 ] = { 0x55,0x04,0x03 ,0x00 ,0x00 ,0x00 ,0x00 ,0xbb };	/*carLight???????????*/
//uint8_t command09[ 8 ] = { 0x55,0x04,0x03 ,0x01 ,0x00 ,0x00 ,0x00 ,0xbb };	/*carLight???????????*/
//uint8_t command10[ 8 ] = { 0x55,0x04,0x03 ,0x02 ,0x00 ,0x00 ,0x00 ,0xbb };	/*carLight????????????*/
//uint8_t command11[ 8 ] = { 0x55,0x04,0x04 ,0x00 ,0x00 ,0x00 ,0x00 ,0xbb };	/*carLight???????????*/
//
